...
<div id="no-more-tables">
	...
	<h2 style="text-align: center;"><strong>Polycom</strong></h2>
<table width="100%" cellspacing="1" cellpadding="20" border="0" align="center">
    <tbody>
        <tr>
            <td width="50%" valign="top">
            <p style="text-align: justify;">Incremente la productividad de sus llamadas telef&oacute;nicas y de sus conferencias de audio haciendo posible una escucha m&aacute;s n&iacute;tida y la posibilidad de centrarse en lo que se est&aacute; discutiendo.</p>
            </td>
            <td width="50%">
            <p style="text-align: center;"><a href="../userfiles/servicios_tic20/file/Jabra/Jabra BIZ 1500_Datasheet.pdf" target="_blank"><img src="../userfiles/servicios_tic20/image/servicios/comunicaciones_unificadas/polycom_logo.jpg" alt="Plycom" class="img-responsive img-thumbnail image_effects animated" border="0" /></a></p>
            </td>
        </tr>
    </tbody>
</table>
