...
<!-- end about -->
    ...
    <nav>
        <div class="menu">
            <p class="website_name"><img src="./imgusr/logo_servicios_tic.jpg" height="60%"></p>
            <div class="menu_links">
                <a href="index.php" class="link">INICIO</a>
                <a href="contacto.php" class="link">CONTACTANOS</a>
    ...
    <section class="wrapper">
        ...
        <div class="container">
            ...
            <div class="text">
                <article>
                    <p>¡OH NO! Parece que te perdiste. <br>¡Vuelve a la página de inicio si te atreves!</p>
