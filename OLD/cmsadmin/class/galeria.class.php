			...
			if(is_array($arr_galerias) )
			{
				foreach( $arr_galerias as $galerias)
				{
					...
					$salida .= "<tr>
									...
									<td>".$fecha_galeria."</td>
									<td>  
										<p><a href='index.php?q=galerias_edita&s=".$this->generales->encriptar($galerias["galerias_id"],"galeria")."' class='btn btn-primary'>".(($_SESSION["permiso_contenido"] == 1)? "Agregar im&aacute;genes": "Ver" )."</a></p>
										<p><a href='index.php?q=galerias_edita&s=".$this->generales->encriptar($galerias["galerias_id"],"galeria")."' class='btn btn-success btn-mini'>".(($_SESSION["permiso_contenido"] == 1)? "Editar": "Ver" )."</a> ";
										if( intval($galerias["galerias_id"]) != 1 && $_SESSION["permiso_contenido"] == 1)
											$salida .= "<a href='#' data-url='index.php?q=galeria&e=".$this->generales->encriptar($galerias["galerias_id"],"galeria")."' class='btn btn-mini btn-danger delgal' >Eliminar</a></p>";
					$salida .= "	</td>
								</tr>";
				}
			}
