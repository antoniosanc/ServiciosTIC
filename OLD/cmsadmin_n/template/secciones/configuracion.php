	...
	<div>
		...
		<div class="row">
			...
			<?
				...
				if ($arr_configuracion[0]["configuracion_codigo_chat"])
			...
			<form action="index.php?q=configuracion&g=m" method="POST" id="frm_misc" id="frm_misc">
				<div class="form-group">
					...
					<input type="text" name="keyworkds_base" id="keyworkds_base" value="<?=$configuracion_keywords_base?>" class="form-control" placeholder="Escribe las palabras clave de tu sitio para mejorar el posicionamiento en buscadores"/>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label>C&oacute;digo de seguimiento (Analytics):</label>
					...
					<div class="row">
						<form action="backup.php?q=bk&g='.md5(5).'" method="POST" id="frm_bkup" id="frm_bkup" target="_blank">
							<div class="form-group">
								...
								<input type="password" name="usuariodb" id="usuariodb" value="'.NOMBRE_USER_CMS.'" class="form-control" placeholder="Escribe el nombre del usuario de la base de datos"/>
							</div>
							<div class="form-group">
								<label>Password DB:</label>
								<input type="password" name="passworddb" id="passworddb" value="'.NOMBRE_PASS_CMS.'" class="form-control" placeholder="Escribe la contrase&ntilde;a de la base de datos"/>
							</div>
							<div class="form-group">
								<label>DB:</label>
								<input type="password" name="basedatos" id="basedatos" value="'.NOMBRE_DB_CMS.'" class="form-control" placeholder="Escribe el nombre de la base de datos"/>
							</div>
