...
<form action="index.php?q=contenidos_edita&s=<?=$_GET["s"]?>" method="POST" id="formeditacont" name="formeditacont"  enctype="multipart/form-data" >
	<div class="col-md-8">
	...
	<div class="col-md-12">
		...
		?>
			...
			<?
				if($arr_contenido[0]["secciones_superior_id"] == 2 || $arr_contenido[0]["secciones_superior_id"] == 16 || $arr_contenido[0]["secciones_superior_id"] == 19 || $arr_contenido[0]["secciones_superior_id"] == 21 || $arr_contenido[0]["secciones_superior_id"] == 24 || $arr_contenido[0]["secciones_superior_id"] == 28 ||  $arr_contenido[0]["secciones_superior_id"] == 30 ||  $arr_contenido[0]["secciones_superior_id"] == 32)//Desarrollos (2) y Propiedades
				{
			?>
					<!--<h3>Caracter&iacute;sticas</h3>
					<p align="right">-->
					<?
						/*$oFCKeditor = new FCKeditor('contenido_editor_amenidades');
						$oFCKeditor->Width = '100%' ;
						$oFCKeditor->Height = '400';
						$oFCKeditor->BasePath = 'libs/FCKeditor/';
						$oFCKeditor->Value = $arr_contenido[0]["contenido_amenidades"]; //nombre del campo de la base de datos
						$oFCKeditor->Create();*/
					?>
					<!--</p>-->
					...
					<p align="right">
					<?
						$oFCKeditor = new FCKeditor('contenido_editor_mapa');
						$oFCKeditor->Width = '100%' ;
						$oFCKeditor->Height = '400';
						$oFCKeditor->BasePath = 'libs/FCKeditor/';
						$oFCKeditor->Value = $arr_contenido[0]["contenido_mapa"]; //nombre del campo de la base de datos
						$oFCKeditor->Create();
					?>
					</p>
					
					<h3>Imagen del Plano</h3>
					<p align="right">
					<?
						$oFCKeditor = new FCKeditor('contenido_editor_plano');
						$oFCKeditor->Width = '100%' ;
						$oFCKeditor->Height = '400';
						$oFCKeditor->BasePath = 'libs/FCKeditor/';
						$oFCKeditor->Value = $arr_contenido[0]["contenido_plano"]; //nombre del campo de la base de datos
						$oFCKeditor->Create();
					?>
					</p>					
