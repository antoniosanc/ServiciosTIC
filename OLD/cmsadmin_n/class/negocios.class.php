	...
	class negocios extends mail
	{
		...
		function negocios_lista_contactos (  )
		{
			...
			if(is_array($arr_contacto) )
			{
				...
				{
					$fecha_contacto = $this->generales->fecha_formato_humano( $contacto["contacto_fecha_contacto"] );
					...
					$salida .= "<tr>
						...
						$salida .= "</td>
								...
								$salida .= "</td>
									<td>  <a href='index.php?q=negocios_responder&c=".$this->generales->encriptar($contacto["contacto_id"],"contacto")."' class='btn btn-warning'><span class='glyphicon glyphicon-comment'></span> Responder</a></td>
								</tr>";
				}
			}
			return $salida;
