...
(function ($) {
    if ($.fn.ajaxForm == undefined) {
        $.getScript("./libs/jquploader/jquery.form.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span> O arrastre su archivo</span>",
            abortStr: "Detener",
            cancelStr: "Cancelar",
            deletelStr: "Eliminar",
            doneStr: "Guardar",
            multiDragErrorStr: "No es permitido agregar m&uacute;ltiples archivos.",
            extErrorStr: "El tipo de archivo permitido es: ",
            sizeErrorStr: "El tama&ntilde;o m&aacute;ximo es: ",
            uploadErrorStr: "No habilitado"
        }, options);
        ...
        function createProgressDiv(obj, s) {
            ...
            this.done = $("").appendTo(this.statusbar).hide();
