...
-webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; background-attachment: fixed;">
		...
		<div class="container">
		  ...
		  <form class="form-signin" method="POST" action="admin-login.php" id="commentForm">
			...
			<h2 style="text-align:center;" class="form-signin-heading">Inicia Sesi&oacute;n</h2>
			...
			<p align="center"><button class="btn btn-warning" type="submit"> Entrar <span class="glyphicon glyphicon-log-in"></span></button></p>
			...
			<div class="col-md-6"> <p align="center"><a href="../index.php" class="  btn-sm"><span class="glyphicon glyphicon-home"></span> Ir a tu sitio web</a></p></div>

			<div class="col-md-6"> <p align="center"><a href="https://www.solucionesim.net/index.php?q=contacto&g=cmsadmin" target="_blank" class="  btn-sm"><span class="glyphicon glyphicon-question-sign"></span> Solicitar ayuda</a></p></div>
