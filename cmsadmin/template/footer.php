...
<div id="footer">
	<div class="container">
		<br/>
		<p class="text-muted">Desarrollado por <a href="https://www.solucionesim.net" target="_blank">Soluciones IM</a>. Todos los derechos reservados <?=date("Y")?></p>
	</div>
</div>
	...
	<script src="./js/<?=strtolower($_GET["q"])?>.js"></script>
