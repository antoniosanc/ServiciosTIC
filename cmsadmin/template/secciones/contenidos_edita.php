...
<?
	...
	if(!empty($_POST) && $_SESSION["permiso_contenido"] == 1)
	{
		...
		{
			if($seccion_url = $contenidos->contenidos_guarda_contenido( $_POST ) )
			{
...
<div class="page-header">
	<h1><?=intval($seccion_id)?> - <?=ucfirst($arr_contenido[0]["contenido_titulo"])?> <small> <a target="_blank" href="../index.php?q=<?=$arr_contenido[0]["secciones_url"]?>"><abbr title="URL de la secci&oacute;n">index.php?q=<?=$arr_contenido[0]["secciones_url"]?></abbr></a> </small></h1>
</div>
<div class="container">
