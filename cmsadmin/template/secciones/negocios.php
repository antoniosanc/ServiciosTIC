<?
	...
	if( strtolower($_GET["g"]) == "c" && $_SESSION["permiso_centro_negocios"] == "1" && !empty($_POST) )
	{
		if( $negocios->negocios_envia_correo_contacto( $_POST ) )
			...
			echo alerta('Ocurrio un error al enviar el correo electr&oacute;nico. Intenta nuevamente');
	}
?>
...
<div class="page-header">
	...
	<p align="right"><a href="./exportar.php?q=base" class="btn btn-success btn-sm target="_blank"><span class="glyphicon glyphicon-download-alt"></span> Descargar datos</a></p>
