...
<div class="container">
	...
	<div class="row">
		...
		<form method="POST" action="index.php?q=negocios&g=c" name="frm_contacto" id="frm_contacto">
			...
			?>
			<br/>
			<p align="center"> <button class="btn btn-warning" type="submit"> <i class=" glyphicon glyphicon-send"></i> Enviar</button></p>
		</form>
	</div>
</div>
	...
	<div class='modal-dialog modal-lg'>
		<div class='modal-content'>
			...
			<div class='modal-footer'>
				<button class='btn btn-danger btn-sm' data-dismiss='modal' aria-hidden='true'> <i class="glyphicon glyphicon-remove"></i> Cerrar</button>
			</div>
		</div>
	</div>
</div>