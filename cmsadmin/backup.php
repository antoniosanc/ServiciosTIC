...
<html lang="es">
	...
	<?
		...
		if( $_GET["q"] == "bk" && $_GET["g"] == md5(5) && !empty($_SESSION["uid"]) )
...

		{
			...
			$mysqli = new mysqli($params['db_host'], $params['db_uname'], $params['db_password'], $params['db_to_backup'], $params["port_db"]);
