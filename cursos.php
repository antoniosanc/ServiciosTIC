        ...
        <div class="row ">
							...
							<table class="table table-striped">
						    	<tbody>
								    ...
								    <tr> <!-- ARAD -->
										...
										<td>Impartido por Clemente M. González P. </td>
									</tr>
									<tr>
		    ...
		    <div class="col-sm-12">
				...
				<h3>A quién está dirigido</h3>
					<p>A todo el personal de su empresa, y que debe de tener el conocimiento básico y esencial de los términos, tecnologías y tendencias  de la industria de  Alarmas de intrusión y automatización</p>
						
				<h3>Objetivo</h3>
					<p>El Asistente conocerá  el área de<br>Alarmas de intrusión y automatización utilizadas en distintos ámbitos , así como sus características principales y funcionalidades<br></p>
		    </div>
		    <br>	
		    <div class="col-sm-12" >
